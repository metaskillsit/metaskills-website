      ...
      <div className="max-w-[1140px] mx-auto px-6 py-16 md:py-20">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-muted rounded-sm p-8 border border-border flex flex-col items-center text-center"
          >
            ...
            <p className="body-p mb-6">
              {t("admissions.whatsappDesc")}
            </p>
            <a
