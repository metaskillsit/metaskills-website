...
import pastClass75 from "@/assets/past-class-75.jpg";
import pastClass74 from "@/assets/past-class-74.jpg";
import pastClass73 from "@/assets/past-class-73.jpg";
import pastClass72 from "@/assets/past-class-72.jpg";
import pastClass64 from "@/assets/past-class-64.jpg";
import pastClass63 from "@/assets/past-class-63.jpg";
import pastClass61 from "@/assets/past-class-61.jpg";
import pastClass59 from "@/assets/past-class-59.jpg";
import pastClass56 from "@/assets/past-class-56.jpg";
import pastClass53 from "@/assets/past-class-53.jpg";

const photos = [
  { src: pastClass75, caption: "Corporate AI Training — Classroom Session 2026" },
  { src: pastClass74, caption: "AI Compute Economics — Studio Lab Session" },
  { src: pastClass73, caption: "AI-Native Prototyping — Developer Workshop" },
  { src: pastClass72, caption: "Tech Conference Singapore — Keynote Audience" },
  { src: pastClass64, caption: "Bank of China Singapore — Enterprise AI Briefing" },
  { src: pastClass63, caption: "AI Literacy for Financial Professionals — NTUC LearningHub" },
  { src: pastClass61, caption: "AI Literacy for Financial Professionals — Full Classroom" },
  { src: pastClass59, caption: "Data & AI Workshop — Hands-On Lab Session" },
  { src: pastClass56, caption: "Enterprise AI Workshop — Lecture Theatre Session" },
  { src: pastClass53, caption: "Generative AI Workshop — Large Cohort Session" },
