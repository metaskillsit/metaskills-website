...
import {
  Shield, Cpu, Eye, Activity, ArrowRight, CheckCircle2,
  AlertTriangle, BookOpen, Layers, Users, Bot, Brain,
  Building2, FileCheck, Workflow, MessageCircle, ExternalLink,
  ChevronRight, Landmark, BarChart3, Briefcase, Lock,
  Server, Zap, Target, Globe
} from "lucide-react";
import Navbar from "@/components/Navbar";
import FooterSection from "@/components/FooterSection";

const WA_LINK = "https://wa.me/6589483482?text=Hi%20I'm%20interested%20in%20your%20Agentic%20AI%20Governance%20solutions.%20Can%20we%20schedule%20a%20strategy%20session%3F";
    ...
    <div className="min-h-screen bg-[hsl(220,25%,6%)] text-[hsl(220,15%,95%)]">
      ...
      <main className="pt-16 md:pt-[70px]">
        ...
        <section className="relative overflow-hidden py-20 md:py-32 lg:py-40">
          ...
          <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: "radial-gradient(circle at 1px 1px, hsl(43,96%,56%) 1px, transparent 0)", backgroundSize: "40px 40px" }} />
          ...
          <div className="relative z-10 max-w-[1140px] mx-auto px-6">
            <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={0} className="max-w-3xl">
              ...
              <h1 className="font-heading text-3xl md:text-5xl lg:text-6xl font-bold leading-[1.1] mb-4">
                Agentic AI —{" "}
                <span className="text-[hsl(var(--gold))]">With Governance Built&nbsp;In,</span>{" "}
                Not Bolted&nbsp;On.
              </h1>
              <p className="text-base md:text-lg text-[hsl(220,15%,65%)] leading-relaxed max-w-2xl mb-8">
                We design and deploy end-to-end agentic AI systems where every action is controlled, auditable, and aligned with business rules.
              </p>
              <div className="flex flex-wrap gap-4">
                <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[hsl(var(--gold))] text-[hsl(220,25%,6%)] font-semibold px-6 py-3 rounded-md hover:brightness-110 transition-all">
                  <MessageCircle className="w-4 h-4" /> Book a Strategy Session
                </a>
                <a href="#research" className="inline-flex items-center gap-2 border border-[hsl(220,20%,25%)] text-[hsl(220,15%,80%)] font-medium px-6 py-3 rounded-md hover:border-[hsl(var(--gold),0.5)] hover:text-[hsl(var(--gold))] transition-all">
                  <BookOpen className="w-4 h-4" /> Explore Agentic Research
                </a>
              </div>
            </motion.div>
                ...
                {["Trust", "Execution", "Verification", "Observation"].map((label, i) => (
                  <div key={label} className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2 border border-[hsl(220,20%,18%)] bg-[hsl(220,25%,10%)] rounded-md px-4 py-2.5">
                      {[Shield, Workflow, FileCheck, Eye][i] && (() => { const Icon = [Shield, Workflow, FileCheck, Eye][i]; return <Icon className="w-4 h-4 text-[hsl(var(--gold))]" />; })()}
        ...
        <section className="py-16 md:py-24 bg-[hsl(220,25%,8%)] border-t border-[hsl(220,20%,12%)]">
          <div className="max-w-[1140px] mx-auto px-6">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0}>
              <p className="text-xs font-semibold uppercase tracking-widest text-[hsl(var(--gold))] mb-2">Understanding the Shift</p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={1}>
                <p className="text-[hsl(220,15%,70%)] leading-relaxed mb-4">
                  Agentic AI refers to artificial intelligence systems that can <strong className="text-[hsl(220,15%,90%)]">plan, decide, and act autonomously</strong>. Unlike traditional AI that responds to single prompts, agentic AI can execute complex, multi-step workflows independently.
                </p>
                <p className="text-[hsl(220,15%,70%)] leading-relaxed mb-6">
                  These systems leverage tools, access data sources, maintain memory across interactions, and make decisions to accomplish goals — fundamentally changing how enterprises operate.
                </p>
                <a
                ...
                >
                  <ExternalLink className="w-4 h-4" /> Agentic AI Governance Research (Singapore IMDA) <ArrowRight className="w-3.5 h-3.5" />
                </a>
              </motion.div>
        ...
        <section className="py-16 md:py-24 bg-[hsl(220,25%,6%)] border-t border-[hsl(220,20%,12%)]">
          <div className="max-w-[1140px] mx-auto px-6">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0} className="text-center max-w-2xl mx-auto mb-12">
              ...
              <h2 className="font-heading text-2xl md:text-4xl font-bold mb-4">Why Most AI Agent Deployments Fail in Enterprises</h2>
        ...
        <section id="research" className="py-16 md:py-24 bg-[hsl(220,25%,8%)] border-t border-[hsl(220,20%,12%)]">
          <div className="max-w-[1140px] mx-auto px-6">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0} className="max-w-2xl">
              <p className="text-xs font-semibold uppercase tracking-widest text-[hsl(var(--gold))] mb-2">Industry Intelligence</p>
              <h2 className="font-heading text-2xl md:text-4xl font-bold mb-6">The Rise of Agentic Governance</h2>
            </motion.div>
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              {[
                { icon: Landmark, title: "Government Frameworks", desc: "Governments worldwide, led by Singapore's IMDA, are introducing governance frameworks specifically designed for autonomous AI agents — focusing on accountability, control, and verification." },
                { icon: Globe, title: "Emerging Standards", desc: "Industry bodies are establishing standards for agentic AI deployment, covering agent identity, permission boundaries, audit requirements, and inter-agent communication protocols." },
                { icon: Zap, title: "Enterprise Infrastructure", desc: "Agentic AI is rapidly shifting from experimentation to enterprise infrastructure. Organizations that embed governance early will lead; those that don't will face regulatory and operational risk." },
              ].map(({ icon: Icon, title, desc }, i) => (
                <motion.div key={title} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={i + 1}
        ...
        <section className="py-16 md:py-24 bg-[hsl(220,25%,6%)] border-t border-[hsl(220,20%,12%)]">
          <div className="max-w-[1140px] mx-auto px-6">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0} className="text-center max-w-2xl mx-auto mb-14">
              <p className="text-xs font-semibold uppercase tracking-widest text-[hsl(var(--gold))] mb-2">Our Approach</p>
              <h2 className="font-heading text-2xl md:text-4xl font-bold mb-4">The Metaskills Agentic Governance System</h2>
              <p className="text-[hsl(220,15%,60%)]">We provide a full end-to-end system — not just tools. Every layer is designed for enterprise-grade control, compliance, and scale.</p>
            </motion.div>

            {/* 4-Layer Framework */}
            <div className="mb-20">
              <motion.h3 initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0}
                className="font-heading text-xl md:text-2xl font-bold text-center mb-10"
              >Our Governance Architecture</motion.h3>
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                {[
                  { icon: Shield, layer: "Trust Plane", desc: "Policies, roles, and authority boundaries that define what agents can and cannot do.", color: "43,96%,56%" },
                  { icon: Workflow, layer: "Execution Plane", desc: "Controlled workflow execution with policy enforcement at every step.", color: "43,80%,50%" },
                  { icon: FileCheck, layer: "Verification Layer", desc: "Pre-action checks, validation gates, and human-in-the-loop approvals.", color: "43,70%,45%" },
                  { icon: Eye, layer: "Observation Layer", desc: "Real-time logs, monitoring dashboards, and comprehensive audit trails.", color: "43,60%,40%" },
                ].map(({ icon: Icon, layer, desc, color }, i) => (
                  <motion.div key={layer} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={i + 1}
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0}>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
                {[
                  ...
                  <motion.div key={text} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={i * 0.5}
        ...
        <section className="py-16 md:py-24 bg-[hsl(220,25%,8%)] border-t border-[hsl(220,20%,12%)]">
          <div className="max-w-[1140px] mx-auto px-6">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0} className="text-center mb-12">
              <p className="text-xs font-semibold uppercase tracking-widest text-[hsl(var(--gold))] mb-2">Delivery Process</p>
        ...
        <section className="py-16 md:py-24 bg-[hsl(220,25%,6%)] border-t border-[hsl(220,20%,12%)]">
          <div className="max-w-[1140px] mx-auto px-6">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0} className="text-center mb-12">
              <p className="text-xs font-semibold uppercase tracking-widest text-[hsl(var(--gold))] mb-2">Applications</p>
              <h2 className="font-heading text-2xl md:text-4xl font-bold">Enterprise Use Cases</h2>
            </motion.div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {[
                { icon: Building2, title: "AI BPO Operations", desc: "Automated SLA management, intelligent ticketing, and triage with full audit compliance." },
                { icon: BarChart3, title: "Financial Workflows", desc: "Compliance-first AI agents for reporting, reconciliation, and regulatory processes." },
                { icon: Bot, title: "Enterprise Copilots", desc: "AI assistants with governed access to enterprise data, tools, and decision frameworks." },
                { icon: Brain, title: "Decision Intelligence", desc: "Multi-agent systems that support strategic decisions with traceable reasoning chains." },
                { icon: Briefcase, title: "Regulated Industries", desc: "Healthcare, finance, and government deployments requiring strict governance controls." },
              ].map(({ icon: Icon, title, desc }, i) => (
        ...
        <section className="py-16 md:py-24 bg-[hsl(220,25%,8%)] border-t border-[hsl(220,20%,12%)]">
          <div className="max-w-[1140px] mx-auto px-6">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0} className="text-center mb-12">
              ...
              <p className="text-[hsl(220,15%,60%)] max-w-xl mx-auto">We don't just advise — we build, deploy, and govern.</p>
            </motion.div>
        ...
        <section className="py-20 md:py-32 bg-gradient-to-b from-[hsl(220,25%,6%)] to-[hsl(220,30%,4%)] border-t border-[hsl(220,20%,12%)]">
          <div className="max-w-[1140px] mx-auto px-6 text-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0}>
              <h2 className="font-heading text-2xl md:text-4xl lg:text-5xl font-bold mb-4">
                Don't Just Build AI Agents.{" "}
                <span className="text-[hsl(var(--gold))]">Build Them Right.</span>
              </h2>
