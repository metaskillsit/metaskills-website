...
const aiTeam = [
  ...
  },
  {
    name: "Evelyn Wong",
    role: "Consultant",
    expertise: "Data Governance | Business & Data Analytics | Adult Learning | Compliance & Risk Management | Lean Six Sigma | Agile & Scrum",
    image: evelynImg,
    bio: "Evelyn Wong is a data governance specialist who currently leads Infinuem, playing a pivotal role in data governance initiatives—developing and implementing frameworks, policies, standards, and roles that elevate data quality, ensure compliance, and enable trustworthy AI and analytics. She has worked across functions—finance, IT, risk, marketing, and data science—to harmonise data ownership and stewardship, ensuring integrated analytics while maintaining regulatory standards under PDPA and GDPR.\n\nBeyond governance, Evelyn brings an extensive corporate background spanning Compliance, Business Development, Sales & Marketing, and Project Management at 3M and Agilent Technologies. She is adept in software development, data analysis, machine learning, and natural language processing. A Certified Lean Six Sigma Green Belt and Certified Scrum Master, she is well-versed in applying Lean Six Sigma, Agile, and Scrum methodologies across organisations.\n\nEvelyn is also an experienced adult learning practitioner, having trained more than 200 professionals in data analytics, business intelligence, and machine learning tools including Power BI, MySQL, Python, and VBA. She is an Adjunct Trainer with SMU Academy and JCube Institute, equipping mid-career professionals with the skills to transition into data and AI roles.\n\nHer professional education includes certifications in IT service management, enterprise architecture, and algorithmic trading—underscoring her commitment to continuous learning and excellence in her field.",
  },
  {
