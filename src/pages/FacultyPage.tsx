...
His other distinctive focus is AI governance as an operational discipline rather than a policy exercise. He has implemented and maintained an ISO/IEC 42001 AI Management System alongside ISO/IEC 27001, carried through external surveillance audit, covering AI system inventory and classification, impact assessment, supplier and model controls, and the evidence trail auditors actually request. He trains teams on how governance requirements translate into delivery artefacts: how an AI system gets classified, what must be documented at each stage, and how to build an evidence base that survives an audit rather than being reconstructed the week before one.
Before moving into AI delivery, Benjamin worked in commodity markets and capital markets, in analyst roles at GAO Capital, Treehouse Analytics, and BP, covering supply and demand modelling, valuation, strategy backtesting, and portfolio positioning. That grounding shapes how he teaches AI to finance and operations audiences, in the language of margin, exposure, and decision quality rather than model architecture.
He graduated Summa Cum Laude from Singapore Management University with a Bachelor of Business Management, was a Dean's List recipient across four academic years, and studied Finance and Financial Analytics at Boston University as a recipient of the Ministry of Foreign Affairs US-Singapore Scholarship, where he was top scorer in Financial Analytics. His teaching practice began early: as an adviser to a coding enrichment centre he delivered Python workshops in collaboration with Smart Nation Singapore, and he has served on judging panels for the Temasek-NUS and SMU stock pitch competitions.`,
  },
  {
    name: "Brendan Graetz",
...
A defining professional milestone for Steven was a corporate attachment with a global cybersecurity and threat-intelligence firm that partners with international law enforcement agencies, including Europol, to combat cybercrime. Working alongside front-line investigators gave him first-hand insight into the operational practices, technologies, and investigative methods used against sophisticated, transnational cyber threats. The experience deepened his expertise in cyber threat intelligence, digital forensics, incident response, and international cybercrime investigations, while bridging the gap between academic knowledge and current industry practice. Today, he draws on those real-world case perspectives and contemporary security practices to enrich his teaching, research, and the development of the next generation of cybersecurity professionals.
...
As an aspiring academic leader, Johnson has an extensive track record of institutional capacity building across leading universities, single-handedly upskilling over 1,000 adult learners, including senior technical staff at NUS and AI Singapore. Separately pairing his domain mastery of Python, DevSecOps, and Agentic AI with structured adult learning frameworks (ACTA, AFHEA), Johnson consistently delivers measurable training outcomes, empowering the next generation of engineers and security professionals to thrive in highly regulated environments.
Professional Credentials & Applied Technical Coursework
