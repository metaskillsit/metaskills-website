            ...
            <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={0} className="max-w-3xl">
              ...
              <div className="flex flex-wrap gap-4 items-start">
                <div className="relative">
                  <a href="https://terrene.foundation/" target="_blank" rel="noopener noreferrer" className="absolute -bottom-3 -right-2 flex items-center gap-1.5 text-[9px] text-[hsl(220,15%,55%)] uppercase tracking-wider border border-[hsl(220,20%,25%)] bg-[hsl(220,25%,10%,0.8)] backdrop-blur-sm rounded-full px-2.5 py-1 hover:border-[hsl(var(--gold),0.4)] hover:text-[hsl(var(--gold))] transition-all z-10">
