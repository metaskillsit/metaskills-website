...
const FacultyPage = () => {
return ( <div> <Navbar /> <main className="pt-16"> <section className="py-16"> <div className="max-w-[1140px] mx-auto px-6"> <TeamSection title="Executive Team" members={executiveTeam} /> <TeamSection title="AI Team" members={aiTeam} /> <TeamSection title="Algo Trading Team" members={algoTradingTeam} /> <TeamSection title="Cyber Team" members={cyberTeam} /> <TeamSection title="Adjunct Trainers" members={adjunctTrainers} /> </div> </section> </main> <FooterSection /> </div>
);
};
