...
One of the most significant professional achievements of Steven was the opportunity (via industry attachment) to join a Multi-National Corporation (MNC), a globally recognised cybersecurity and threat intelligence organisation that works closely with international law enforcement agencies, including Europol, in the fight against cybercrime. This attachment represented a valuable opportunity to gain first-hand exposure to the operational practices, technologies, and investigative approaches employed in addressing sophisticated and transnational cyber threats. Engagement with like-minded cybersecurity professionals provided an enhanced understanding of cyber threat intelligence, digital forensics, incident response, and cybercrime investigations within an international context. The experience was particularly significant in strengthening Steven's professional competencies and bridging the gap between academic knowledge and current industry practices. Furthermore, exposure to an organisation contributing to international cybercrime investigations has enriched his capacity to incorporate contemporary cybersecurity knowledge, real-world case perspectives, and industry-relevant practices into teaching, research, and the development of future cybersecurity professionals.
